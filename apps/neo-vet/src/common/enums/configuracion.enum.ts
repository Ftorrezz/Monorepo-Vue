...
export enum Tabla {
    ...
    TIPO_PENSION = 25,
    TIPO_JAULA = 26,
    SERVICIO_ADICIONAL_PENSION = 27,
    MOTIVO_CANCELACION_PENSION = 28,
    ACTIVIDAD_TURNO = 29,
}
...
export const RelacionModuloTipo = {
    ...
    [Modulo.INVENTARIO]: [Tabla.CATEGORIA_PRODUCTO, Tabla.TIPO_PRODUCTO, Tabla.UNIDAD_MEDIDA, Tabla.FORMA_FARMACEUTICA, Tabla.UBICACION, Tabla.FABRICANTE],
    [Modulo.ATENCION]: [Tabla.MOTIVOCONSULTA],
    [Modulo.PENSION]: [Tabla.TIPO_PENSION, Tabla.TIPO_JAULA, Tabla.SERVICIO_ADICIONAL_PENSION, Tabla.MOTIVO_CANCELACION_PENSION, Tabla.ACTIVIDAD_TURNO],
};
