      ...
      <div class="col-12 col-md-4 col-xl-3">
        <q-card flat class="modern-sidebar full-height shadow-1">
          <div class="row full-height no-wrap">
            <!-- Columna 1: Módulos (Iconos + Texto opcional) -->
            <div 
              class="module-strip bg-primary text-white flex flex-center q-py-md transition-all"
              :style="{ width: sidebarMini ? '80px' : '150px' }"
            >
              <q-list class="full-width">
                ...
                >
                  <q-item-section class="flex flex-center">
                    ...
                    <div v-if="!sidebarMini" class="text-caption text-center q-mt-xs line-height-1">
                      {{ modulo.descripcion }}
                    </div>
            ...
            <div class="tables-column col grow q-pa-md">
              <div class="text-overline text-grey-7 q-mb-sm">Repositorio</div>
              <div v-if="moduloSeleccionado" class="text-h6 text-weight-bold q-mb-lg text-primary ellipsis">
        ...
        >
          ...
          <div v-else key="empty" class="flex flex-center full-height full-width" style="min-height: 70vh">
            <div class="text-center">
              ...
              <div class="text-h4 text-weight-bolder text-primary q-mt-xl">Estructura BioNeodimio</div>
