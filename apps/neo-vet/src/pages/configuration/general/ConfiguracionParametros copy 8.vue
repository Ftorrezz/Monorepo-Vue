  ...
  <div class="q-pa-xl bg-slate-50 min-height-screen font-outfit text-blue-grey-10 overflow-hidden relative-position">
    ...
    <transition name="portal-transition" mode="out-in">
      ...
      <div v-if="!moduloSeleccionado" key="portal" class="full-width q-px-lg">
        <!-- Header del Portal (Estilo BaseCrud) -->
        <q-card flat class="bg-gradient-primary text-white q-mb-xl animated fadeInDown shadow-2">
          <q-card-section class="q-pa-lg text-center">
            ...
            <h1 class="text-h3 text-weight-black q-mt-none q-mb-xs">Centro de Control</h1>
            <p class="text-subtitle2 opacity-80 text-weight-medium">Gestione las configuraciones maestras del ecosistema</p>
          </q-card-section>
        </q-card>
        ...
        <div class="row q-col-gutter-lg no-wrap items-stretch" style="height: calc(85vh - 120px)">
          ...
          <div class="col-auto" style="width: 300px">
            <q-card flat class="table-list-card full-height shadow-minimal overflow-hidden bordered">
              <div class="q-pa-md border-bottom bg-grey-2">
                <div class="row items-center">
                  <q-icon name="list" color="primary" class="q-mr-sm" size="xs" />
                  <div class="text-overline text-blue-grey-9 text-weight-black letter-spacing-1">Tablas Disponibles</div>
                </div>
              </div>
            ...
            <q-card flat class="data-workspace-card-light full-height shadow-minimal overflow-hidden relative-position bordered">
              ...
              <transition name="fade-slide" mode="out-in">
                <div v-if="tablaSeleccionada" :key="tablaSeleccionada.id">
                  ...
                  >
                    <template v-slot:top>
                      <div class="row full-width items-center q-px-lg q-py-md bg-grey-1 border-bottom">
                        <div class="text-subtitle1 text-weight-bold text-primary uppercase letter-spacing-1">
                        ...
                        <div class="row q-gutter-md items-center">
                          ...
                          <q-btn flat round icon="download" color="grey-7" @click="exportarDatos">
