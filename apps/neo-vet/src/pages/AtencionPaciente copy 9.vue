    ...
    <q-card class="q-mb-md rounded-borders shadow-2">
      <q-card-section class="q-py-md q-px-lg">
        <div class="row items-center q-col-gutter-md no-wrap">
          <div class="col-auto">
            <q-avatar size="64px" icon="pets" color="primary" text-color="white" />
          </div>
          <div class="col">
            <div class="text-h6 q-mb-xs text-primary">
              <q-icon name="event" class="q-mr-sm" />
              Historial de Atenciones de: <span class="text-weight-bold">{{ paciente.nombre }}</span>
            </div>
