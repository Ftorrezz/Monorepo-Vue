      ...
      <q-card elevated>
        ...
        <q-card-section class="row q-col-gutter-xs">
          <q-item class="col-lg-2 col-md-6 col-sm-12 col-xs-12">
            <q-item-section>
              <q-input v-model="formData.propietario.primerapellido" label="Primer Apellido" />
            </q-item-section>
          </q-item>
          <q-item class="col-lg-2 col-md-6 col-sm-12 col-xs-12">
            <q-item-section>
              <q-input v-model="formData.propietario.segundoapellido" label="Segundo Apellido" />
            </q-item-section>
          </q-item>
          <q-item class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
            <q-item-section>
              <q-input v-model="formData.propietario.nombre" label="Nombres" />
            </q-item-section>
          </q-item>
          <q-item class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
            <q-item-section>
          ...
          <q-item class="col-lg-2 col-md-6 col-sm-12 col-xs-12">
            <q-item-section>
              <q-input v-model="formData.propietario.telefonocelular" label="Telefono móvil" lazy-rules>
                <template v-slot:prepend>
      ...
      <q-card elevated>
        ...
        <q-card-section class="row q-col-gutter-xs">
          <q-item class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
            <q-item-section>
              <q-input v-model="formData.mascota.nombre" label="Nombre" />
            </q-item-section>
          </q-item>
          <q-item class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
            <q-item-section>
              <q-input v-model="formData.mascota.historia_clinica" label="Historia Clínica" />
            </q-item-section>
          </q-item>
        </q-card-section>
      </q-card>
