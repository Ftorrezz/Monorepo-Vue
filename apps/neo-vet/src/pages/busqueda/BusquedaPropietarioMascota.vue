  ...
  <q-page>
    <div class="row q-col-gutter-xs q-ma-xs q-mr-sm">
      ...
      <!--<div class="col-lg-12 col-md-6 col-sm-12 col-xs-12">
        <CardBusquedaPropietarioPaciente v-for="item in 5" :key="item" />
      </div>-->
    </div>
...
import CardBusquedaPropietarioPaciente from "../components/CardBusquedaPropietarioPaciente.vue";

export default defineComponent({
  name: "busquedapropietariomascota",
