<template>
  <q-page class="q-pa-md full-width">
    ...
    <q-card class="q-mb-md" v-if="atenciones[atencionActual].estado === 'En curso'">
      <q-card-section>
    ...
    <q-card>
      <q-card-section class="q-pa-none">
        <div v-if="serviciosAplicados.length === 0" class="text-center q-py-xl text-grey-6" style="height: 300px; display: flex; flex-direction: column; justify-content: center; align-items: center;">
          ...
          <div class="text-subtitle2">Usa las cards de arriba para añadir servicios</div>
        </div>
...
.service-card:hover:not(.service-card--added) {
...
.service-card--vacunacion:hover:not(.service-card--added) {
  border-color: #4caf50 !important;
  box-shadow: 0 12px 24px rgba(76, 175, 80, 0.2) !important;
}

.service-card--desparacitacion:hover:not(.service-card--added) {
  border-color: #ff9800 !important;
  box-shadow: 0 12px 24px rgba(255, 152, 0, 0.2) !important;
}

.service-card--exploracion:hover:not(.service-card--added) {
  border-color: #2196f3 !important;
  box-shadow: 0 12px 24px rgba(33, 150, 243, 0.2) !important;
}

.service-card--certificado:hover:not(.service-card--added) {
  border-color: #9c27b0 !important;
  box-shadow: 0 12px 24px rgba(156, 39, 176, 0.2) !important;
}

.service-card--cirugia:hover:not(.service-card--added) {
  border-color: #f44336 !important;
  box-shadow: 0 12px 24px rgba(244, 67, 54, 0.2) !important;
}

.service-card--laboratorio:hover:not(.service-card--added) {
...
.service-card:hover:not(.service-card--added) .service-icon {
  transform: scale(1.1);
}
...
/* Estilos existentes del componente original */
.min-width-250 {
  min-width: 250px;
}
