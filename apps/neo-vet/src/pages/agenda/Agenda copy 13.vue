  ...
  <div class="fullscreen-calendar">
    <div class="app-layout">
      ...
      <div class="services-header">
        <div class="services-container">
          <div class="row q-col-gutter-md">
            <!-- Panel de selección de servicios (8 columnas) -->
            <div class="col-8">
              <div class="service-selector-card">
                <div class="service-header q-mb-sm">
                  <q-icon name="medical_services" size="24px" color="primary" />
                  <span class="service-title">Servicios Veterinarios</span>
                </div>
                
                <!-- Tarjeta de servicio seleccionado que despliega el menú -->
                <div class="selected-service-card" @click="showServiceMenu = true">
                  <div v-if="selectedService" class="selected-service-content">
                    <div class="service-avatar-section">
                      <q-avatar :color="selectedService.color" text-color="white" size="56px">
                        <q-icon :name="selectedService.icon" size="28px" />
                      </q-avatar>
                  ...
                  <div v-else class="empty-service-content">
                    <q-icon name="add_circle_outline" size="40px" color="grey-5" />
                    <div class="empty-text">
                      <div class="empty-title">Selecciona un Servicio</div>
                      <div class="empty-subtitle">Haz clic aquí para elegir</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <!-- Panel de estadísticas (4 columnas) -->
            <div class="col-4" v-if="selectedService">
      ...
      <div class="main-calendar">
        ...
        <!-- Vista diaria detallada mejorada -->
        <div v-if="selectedService && viewMode === 'day'" class="day-view-container">
          ...
          <!-- Nueva tabla mejorada de horarios -->
                ...
                <div v-else class="empty-slot">
                  <div class="empty-slot-content">
                    ...
                    <div class="empty-slot-text">
                      ...
                      <div class="empty-slot-subtitle">Haz clic para agendar una cita</div>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <!-- Dialog mejorado para selección de servicios -->
    <q-dialog v-model="showServiceMenu" position="top" class="service-menu-dialog">
      <q-card class="service-menu-card">
        <q-card-section class="service-menu-header">
          <div class="menu-title">
            <q-icon name="medical_services" size="24px" color="primary" />
            <span>Seleccionar Servicio</span>
          </div>
          <q-btn flat round icon="close" @click="showServiceMenu = false" />
        </q-card-section>
        
        <q-card-section class="service-menu-content">
          <div class="services-grid">
            ...
            >
              <div class="service-option-avatar">
                <q-avatar :color="service.color" text-color="white" size="48px">
              ...
              <div class="service-option-content">
                ...
                <div class="service-option-details">
                  <span><q-icon name="schedule" size="14px" /> {{ service.duration }}min</span>
                  <span><q-icon name="attach_money" size="14px" /> ${{ service.price }}</span>
                </div>
              </div>
              
              <div v-if="selectedService?.id === service.id" class="service-option-check">
...
/* Nuevo selector de servicios como tarjeta */
...
/* Dialog de selección de servicios */
.service-menu-dialog .q-dialog__inner {
  padding-top: 80px;
}
...
/* Nueva vista diaria mejorada con grid de tarjetas */
.day-view-container {
  flex: 1;
  padding: 24px 32px;
  overflow: auto;
...
.service-menu-content::-webkit-scrollbar,
.search-results::-webkit-scrollbar {
  width: 8px;
}

.appointments-grid::-webkit-scrollbar-track,
.service-menu-content::-webkit-scrollbar-track,
...
.service-menu-content::-webkit-scrollbar-thumb,
...
.service-menu-content::-webkit-scrollbar-thumb:hover,
