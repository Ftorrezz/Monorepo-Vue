            ...
            <div class="calendar-grid">
              ...
              >
                <div class="day-header">
                  <span class="day-number" :class="{ 'today-circle': day.isToday }">{{ day.date }}</span>
                  <div class="day-stats" v-if="day.isCurrentMonth && !day.isPast && !day.isWeekend && day.hasAgenda">
                    <span class="available-badge" v-if="day.availableSlots > 0">{{ day.availableSlots }}</span>
                    <span class="booked-badge" v-if="day.bookedSlots > 0">{{ day.bookedSlots }}</span>
                  </div>
                </div>

                <!-- Horarios del día -->
                <div class="day-slots-summary" v-if="day.isCurrentMonth && !day.isPast && !day.isWeekend && day.hasAgenda">
                  <div
                  ...
                  <div v-if="day.slots.length > 4" class="more-slots">
                    +{{ day.slots.length - 4 }} citas más
                  </div>
                </div>

                <!-- Mensaje para días sin agenda -->
                <div v-if="day.isCurrentMonth && !day.isPast && !day.isWeekend && !day.hasAgenda" class="no-agenda-day">
                  <q-icon name="event_busy" size="xs" color="grey-4" />
...
/* Fines de semana: fondo muy tenue, sin icono invasivo */
.day-cell.weekend {
  background: #f8f8fb;
}
...
/* Círculo sólido azul para el día de hoy */
...
/* Botón "+N citas más" estilo enlace, no gris aburrido */
.more-slots {
  font-size: 11px;
  font-weight: 600;
  color: #448aff;
