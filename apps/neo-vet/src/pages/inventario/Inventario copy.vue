    ...
    <div class="row q-col-gutter-md">
      ...
      >
        <q-card 
          flat 
          bordered 
          class="producto-card full-height"
        ...
        >
          ...
          <q-card-section class="q-pa-sm flex-grow">
            ...
            <div class="q-mb-sm">
              ...
              <div v-if="producto.tipo === 'medicamento' && producto.manejoFraccionado">
                <div class="bg-blue-1 q-pa-xs rounded-borders q-mb-xs">
                  <div class="row items-center no-wrap">
                    <div class="col-grow">
                      <div class="text-body2 text-weight-medium">
                        {{ producto.stockUnidades }} {{ producto.unidadEnvase }}
                      </div>
                      <div class="text-caption text-blue-8">
                        Equiv. {{ calcularDosisDisponibles(producto) }} dosis de {{ producto.dosisPorAplicacion }}{{ producto.unidadDosis }}
                      </div>
                    </div>
                    <q-icon name="medical_services" color="blue" size="sm"/>
                  </div>
                </div>
              </div>
              
              <div v-else class="bg-blue-1 q-pa-xs rounded-borders">
                <div class="row items-center no-wrap">
                  <div class="col-grow">
                    <div class="text-body2 text-weight-medium">
                  ...
                  <q-icon name="inventory" color="blue" size="sm"/>
                </div>
              </div>
            </div>
            ...
            <div class="q-mb-sm">
              ...
              <div class="row q-gutter-xs">
                <div class="col-6">
                  <div class="bg-green-1 q-pa-xs rounded-borders text-center">
                    <div class="text-caption text-green-8">Costo</div>
                    <div class="text-body2 text-weight-bold">
                      ${{ producto.costoUnitario?.toFixed(2) || '0.00' }}
                    </div>
                  </div>
                </div>
                <div class="col-6">
                  <div class="bg-green-1 q-pa-xs rounded-borders text-center">
                    <div class="text-caption text-green-8">Venta</div>
                    <div class="text-body2 text-weight-bold">
              ...
              <div v-if="producto.manejoFraccionado" class="q-mt-xs">
                <div class="bg-purple-1 q-pa-xs rounded-borders text-center">
                  <div class="text-caption text-purple-8">Por Dosis</div>
                  <div class="text-body2 text-weight-bold">
                    ${{ (producto.precioVenta / producto.dosisTotal)?.toFixed(2) || '0.00' }}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div v-if="producto.fechaVencimiento" class="q-mb-sm">
              <div class="text-caption text-weight-medium q-mb-xs"
                   :class="isProximoVencer(producto.fechaVencimiento) ? 'text-deep-orange' : 'text-grey-7'">
            ...
            <div class="row q-gutter-xs q-mb-sm">
              <q-chip 
                ...
                color="blue-grey" 
                size="sm"
                :label="`Lote: ${producto.lote}`"
                icon="qr_code"
              />
              <q-chip 
                v-if="producto.ubicacion"
                dense 
                outline 
                color="blue-grey" 
                size="sm"
                :label="producto.ubicacion"
                icon="place"
              />
            </div>
          </q-card-section>
...
const getCardClass = (producto) => {
  const estado = getEstadoStock(producto)
  const classes = {
    'stock_bajo': 'border-warning',
    'sin_stock': 'border-negative',
    'proximo_vencer': 'border-deep-orange'
  }
...
/* Mejoras visuales para los chips de estado */
.q-chip--dense {
  font-size: 0.75rem;
  font-weight: 500;
}
...
.q-dialog .q-card-section.bg-blue {
...
.producto-card.border-negative {
  opacity: 0.7;
}

.producto-card.border-negative .q-card-actions .q-btn:disabled {
  opacity: 0.5;
}
