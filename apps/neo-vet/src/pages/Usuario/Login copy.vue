            ...
            >
              ...
              <q-list>
                <q-item
                  ...
                  :class="{ 'bg-blue-1': lang.code === currentLanguage.code }"
                >
            ...
            <div class="brand-panel">
              <div class="brand-content">
                ...
                <div class="welcome-section-bottom">
                  <h2 class="welcome-title">{{ texts.welcomeTitle }}</h2>
                  <p class="welcome-description">{{ texts.welcomeDescription }}</p>
                </div>
              </div>
              ...
              <div class="form-wrapper">
                ...
                <q-form class="login-form" @submit.prevent="onSubmit">
                  <q-input
                    ...
                    class="modern-input"
                    placeholder="usuario@neovet.com"
                  >
...
const currentLanguageCode = ref('es');

// Idiomas disponibles con banderas de emoji
const languages = [
...
const translations = {
  es: {
    ...
    welcomeTitle: 'Bienvenido a la nueva era veterinaria',
    welcomeDescription: 'Tecnología avanzada para el cuidado integral de tus pacientes.',
    ...
    signIn: 'Ingresar al Sistema',
    signingIn: 'Verificando...',
    help: 'Centro de ayuda',
    support: 'Soporte técnico',
    version: 'NeoVET v2.0 © 2024'
  },
  en: {
    subtitle: 'Veterinary Management System',
    welcomeTitle: 'Welcome to the new veterinary era',
    welcomeDescription: 'Advanced technology for comprehensive patient care.',
    loginTitle: 'Sign In',
  ...
  fr: {
    subtitle: 'Système de Gestion Vétérinaire',
    welcomeTitle: 'Bienvenue dans la nouvelle ère vétérinaire',
    welcomeDescription: 'Technologie avancée pour les soins complets des patients.',
    loginTitle: 'Se Connecter',
    loginSubtitle: 'Accédez à votre tableau de bord',
    email: 'Utilisateur',
    password: 'Mot de passe',
    rememberMe: 'Se souvenir de la session',
    forgotPassword: 'Mot de passe oublié?',
    signIn: 'Se Connecter au Système',
...
const currentLanguage = computed(() => {
  return languages.find(lang => lang.code === currentLanguageCode.value);
});

const texts = computed(() => {
  return translations[currentLanguageCode.value] || translations.es;
});
...
const changeLanguage = (language) => {
  ...
  $q.notify({
    type: 'positive',
    message: `${language.flag} ${texts.value.subtitle} - ${language.label}`,
    position: 'top',
    timeout: 2000
  });
};
