<template>
  <q-page class="q-pa-md full-width">
    ...
    <q-dialog v-model="showAddServiceDialog" persistent style="width: 700px; max-width: 80vw;">
...
import ServiciosDisponibles from '../components/ServiciosDisponibles.vue' // Nuevo componente
