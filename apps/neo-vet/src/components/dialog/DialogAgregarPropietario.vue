                ...
                <div class="row q-col-gutter-md">
                  ...
                  <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                    <q-card flat bordered class="modern-photo-card">
                      <q-card-section class="column items-center">
                        <div class="modern-photo-container" @click="!camaraActiva && !imagenCapturada && activarCamara()">
                          <video
                  ...
                  <div class="col-lg-10 col-md-9 col-sm-6 col-xs-12">
                    <q-card flat bordered class="modern-info-card">
                      <q-card-section>
                        <div class="text-subtitle1 text-primary q-mb-md">Información Personal</div>
                        <div class="row q-col-gutter-md">
                          ...
                          <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                            <ListaGenero v-model="propietario.id_genero" dense />
                          </div>
