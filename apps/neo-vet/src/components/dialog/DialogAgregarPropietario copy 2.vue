...
const guardarPropietario = async () => {
  ...
  try {
    ...
    datosPropietarioPayload.id_genero = obtenerIDValue(datosPropietarioPayload.id_genero);
    datosPropietarioPayload.id_pais = obtenerIDValue(datosPropietarioPayload.id_pais);
